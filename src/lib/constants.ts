 ...
 */
export const APP_NAME: string = "Baby Shower";
...
export const APP_DESCRIPTION: string =
  "Support new parents and win money in a 50/50 raffle";
 ...
 */
export const APP_TAGS: string[] = ["raffle", "charity", "giving", "community"];
 ...
 */
export const APP_SPLASH_URL: string = `${APP_URL}/icon.png`;

/**
 * Background color for the splash screen.
 * Used as fallback when splash image is loading.
 */
export const APP_SPLASH_BACKGROUND_COLOR: string = "#f96da7";
...
export const APP_ACCOUNT_ASSOCIATION: AccountAssociation | undefined = {
  header:
    "eyJmaWQiOjIxMjA3NCwidHlwZSI6ImF1dGgiLCJrZXkiOiIweDAxYjMyODk4YjRkQjYwZEU1MDQ2ZjA5NDk4Y2ZGNmU3ZDM2MzFkMTgifQ",
  payload: "eyJkb21haW4iOiJiYWJ5LXNob3dlci1ldGEtZ3JlZW4udmVyY2VsLmFwcCJ9",
  signature:
    "TLLP/EIUNYxMgKXoQQeJ/7qNvNPGd7pt5DHEHIj9MVhsOcyCwK0kAM5PEU14jqp6wP5Lli6bAYPOPNSlMyZUsxs=",
};
 ...
 */
export const APP_BUTTON_TEXT: string = "Join the Baby Shower!";
